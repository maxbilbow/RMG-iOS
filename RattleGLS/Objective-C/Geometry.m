...
- (id)init {
    self = [super init];
//    _parent = parent;
//    _vertices = VerticesCube;
//    _indices = IndicesTrianglesCube;
//    _sizeOfVertex = sizeof(VerticesCube);
//    _sizeOfIndices = sizeof(IndicesTrianglesCube);
//    _sizeOfIZero = sizeof(IndicesTrianglesCube[0]);
    return self;
}
